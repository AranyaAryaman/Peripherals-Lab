...
NXT_SEC:
	...
	MOV B,A
	MVI A,1BH
	SIM		;sets interrupt mask and enables interrupts
	EI
	MOV A,B
...
ISR:
	PUSH PSW
	LDA 8000H 	;Location 8000 tells if timer in 'play' or 'pause' mode.
	CPI 00H
	JZ PAUSE 
	MVI A,00H
	STA 8000H
	...
	MVI A,01H
	STA 8000H
	CALL RDKBD 	;When in 'pause' mode, waits for keyboard input
	END_ISR: POP PSW
	EI
	RET
